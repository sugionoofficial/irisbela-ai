export default async function handler(req, res) {
    ...
    try {
        ...
        // Always define the requested scene count from the request body.
        // This avoids "sceneCount is not defined" when an older deployment
        // or a different destructuring scope is used.
        const requestedSceneCount = Math.max(
            1,
...
PENTING:
- Output wajib memiliki tepat ${requestedSceneCount} scene.
